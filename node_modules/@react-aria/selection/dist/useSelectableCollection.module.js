...
import {useRouter as $3H3GQ$useRouter, nodeContains as $3H3GQ$nodeContains, getEventTarget as $3H3GQ$getEventTarget, isCtrlKeyPressed as $3H3GQ$isCtrlKeyPressed, getActiveElement as $3H3GQ$getActiveElement, isFocusWithin as $3H3GQ$isFocusWithin, isTabbable as $3H3GQ$isTabbable, focusWithoutScrolling as $3H3GQ$focusWithoutScrolling, useEvent as $3H3GQ$useEvent, scrollIntoViewport as $3H3GQ$scrollIntoViewport, FOCUS_EVENT as $3H3GQ$FOCUS_EVENT, useUpdateLayoutEffect as $3H3GQ$useUpdateLayoutEffect, CLEAR_FOCUS_EVENT as $3H3GQ$CLEAR_FOCUS_EVENT, scrollIntoView as $3H3GQ$scrollIntoView, mergeProps as $3H3GQ$mergeProps} from "@react-aria/utils";
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
    ...
    let onKeyDown = (e)=>{
        ...
        if (!ref.current || !(0, $3H3GQ$nodeContains)(ref.current, (0, $3H3GQ$getEventTarget)(e))) return;
            ...
            case 'Tab':
                if (!allowsTabNavigation) {
                    ...
                    if (e.shiftKey) ref.current.focus();
                        ...
                        let activeElement = (0, $3H3GQ$getActiveElement)();
                        if (next && (!(0, $3H3GQ$isFocusWithin)(next) || activeElement && !(0, $3H3GQ$isTabbable)(activeElement))) (0, $3H3GQ$focusWithoutScrolling)(next);
                    }
                    break;
                }
        }
    ...
    let onFocus = (e)=>{
        if (manager.isFocused) {
            ...
            if (!(0, $3H3GQ$nodeContains)(e.currentTarget, (0, $3H3GQ$getEventTarget)(e))) manager.setFocused(false);
            return;
        }
        // Focus events can bubble through portals. Ignore these events.
        if (!(0, $3H3GQ$nodeContains)(e.currentTarget, (0, $3H3GQ$getEventTarget)(e))) return;
        ...
        if (manager.focusedKey != null && scrollRef.current) {
            ...
            if (element instanceof HTMLElement) {
                ...
                if (!(0, $3H3GQ$isFocusWithin)(element) && !shouldUseVirtualFocus) (0, $3H3GQ$focusWithoutScrolling)(element);
    ...
    let handlers = {
        ...
        onMouseDown (e) {
            ...
            if (scrollRef.current === (0, $3H3GQ$getEventTarget)(e)) // Prevent focus going to the collection when clicking on the scrollbar.
            e.preventDefault();
        }
    };
