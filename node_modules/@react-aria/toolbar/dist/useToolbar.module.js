...
import {useLayoutEffect as $k3LOe$useLayoutEffect, nodeContains as $k3LOe$nodeContains, getEventTarget as $k3LOe$getEventTarget, getActiveElement as $k3LOe$getActiveElement, filterDOMProps as $k3LOe$filterDOMProps} from "@react-aria/utils";
...
function $2680b1829e803644$export$fa142eb1681c520(props, ref) {
    ...
    const onKeyDown = (e)=>{
        ...
        if (!(0, $k3LOe$nodeContains)(e.currentTarget, (0, $k3LOe$getEventTarget)(e))) return;
        if (orientation === 'horizontal' && e.key === 'ArrowRight' || orientation === 'vertical' && e.key === 'ArrowDown') {
            ...
            e.stopPropagation();
            lastFocused.current = (0, $k3LOe$getActiveElement)();
    ...
    const onBlur = (e)=>{
        if (!(0, $k3LOe$nodeContains)(e.currentTarget, e.relatedTarget) && !lastFocused.current) lastFocused.current = (0, $k3LOe$getEventTarget)(e);
    };
    ...
    const onFocus = (e)=>{
        if (lastFocused.current && !(0, $k3LOe$nodeContains)(e.currentTarget, e.relatedTarget) && (0, $k3LOe$nodeContains)(ref.current, (0, $k3LOe$getEventTarget)(e))) {
