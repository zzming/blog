...
import {useId as $dXlYe$useId, useLayoutEffect as $dXlYe$useLayoutEffect, isFocusWithin as $dXlYe$isFocusWithin, nodeContains as $dXlYe$nodeContains, getEventTarget as $dXlYe$getEventTarget, focusWithoutScrolling as $dXlYe$focusWithoutScrolling, getActiveElement as $dXlYe$getActiveElement, useEvent as $dXlYe$useEvent} from "@react-aria/utils";
...
function $0065b146e7192841$export$7138b0d059a6e743(props, state, ref) {
    ...
    let submenuKeyDown = (e)=>{
        ...
        if (!(0, $dXlYe$isFocusWithin)(e.currentTarget)) return;
        switch(e.key){
            case 'ArrowLeft':
                if (direction === 'ltr' && (0, $dXlYe$nodeContains)(e.currentTarget, (0, $dXlYe$getEventTarget)(e))) {
                    e.preventDefault();
                    e.stopPropagation();
                    onSubmenuClose();
                ...
                break;
            case 'ArrowRight':
                if (direction === 'rtl' && (0, $dXlYe$nodeContains)(e.currentTarget, (0, $dXlYe$getEventTarget)(e))) {
                    e.preventDefault();
                    e.stopPropagation();
                    onSubmenuClose();
                    if (!shouldUseVirtualFocus && ref.current) (0, $dXlYe$focusWithoutScrolling)(ref.current);
            ...
            case 'Escape':
                ...
                if ((0, $dXlYe$nodeContains)(submenuRef.current, (0, $dXlYe$getEventTarget)(e))) {
                    e.stopPropagation();
                    onSubmenuClose();
                    if (!shouldUseVirtualFocus && ref.current) (0, $dXlYe$focusWithoutScrolling)(ref.current);
                }
            ...
            case 'ArrowRight':
                if (!isDisabled) {
                    if (direction === 'ltr') {
                        ...
                        if (type === 'menu' && !!(submenuRef === null || submenuRef === void 0 ? void 0 : submenuRef.current) && (0, $dXlYe$getActiveElement)() === (ref === null || ref === void 0 ? void 0 : ref.current)) (0, $dXlYe$focusWithoutScrolling)(submenuRef.current);
    ...
    (0, $dXlYe$useEvent)(parentMenuRef, 'focusin', (e)=>{
        ...
        if (state.isOpen && (0, $dXlYe$nodeContains)(parentMenuRef.current, (0, $dXlYe$getEventTarget)(e)) && (0, $dXlYe$getEventTarget)(e) !== ref.current) onSubmenuClose();
    });
