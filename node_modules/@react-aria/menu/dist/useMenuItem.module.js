...
import {useRouter as $7Kjv5$useRouter, useSlotId as $7Kjv5$useSlotId, handleLinkClick as $7Kjv5$handleLinkClick, getEventTarget as $7Kjv5$getEventTarget, filterDOMProps as $7Kjv5$filterDOMProps, useLinkProps as $7Kjv5$useLinkProps, mergeProps as $7Kjv5$mergeProps} from "@react-aria/utils";
import {getItemCount as $7Kjv5$getItemCount} from "@react-stately/collections";
import {usePress as $7Kjv5$usePress, useHover as $7Kjv5$useHover, isFocusVisible as $7Kjv5$isFocusVisible, useKeyboard as $7Kjv5$useKeyboard, setInteractionModality as $7Kjv5$setInteractionModality, useFocusable as $7Kjv5$useFocusable} from "@react-aria/interactions";
        ...
        onKeyDown: (e)=>{
            ...
            switch(e.key){
                case ' ':
                    ...
                    (0, $7Kjv5$getEventTarget)(e).click();
                    ...
                    (0, $7Kjv5$setInteractionModality)('keyboard');
                    break;
                case 'Enter':
                    interaction.current = {
                        pointerType: 'keyboard',
                    ...
                    if ((0, $7Kjv5$getEventTarget)(e).tagName !== 'A') (0, $7Kjv5$getEventTarget)(e).click();
                    // click above sets modality to "virtual", need to set interaction modality back to 'keyboard' so focusSafely calls properly move focus
                    // to the newly opened submenu's first item.
                    (0, $7Kjv5$setInteractionModality)('keyboard');
                    break;
