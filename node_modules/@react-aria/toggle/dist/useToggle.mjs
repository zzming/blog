import {getEventTarget as $bvdLj$getEventTarget, mergeProps as $bvdLj$mergeProps, filterDOMProps as $bvdLj$filterDOMProps, useFormReset as $bvdLj$useFormReset} from "@react-aria/utils";
...
function $d2c8e2b0480f3f34$export$cbe85ee05b554577(props, state, ref) {
    ...
    let onChange = (e)=>{
        ...
        e.stopPropagation();
        state.setSelected((0, $bvdLj$getEventTarget)(e).checked);
    };
