...
function $11d770dfabe45077$export$f6b86a04e5d66d90(props, state, ref) {
    ...
    let onFocus = (0, $lBaOG$react.useCallback)((e)=>{
        if (manager.isFocused) {
            ...
            if (!(0, $lBaOG$reactariautils.nodeContains)(e.currentTarget, (0, $lBaOG$reactariautils.getEventTarget)(e))) manager.setFocused(false);
            return;
        }
        // Focus events can bubble through portals. Ignore these events.
        if (!(0, $lBaOG$reactariautils.nodeContains)(e.currentTarget, (0, $lBaOG$reactariautils.getEventTarget)(e))) return;
