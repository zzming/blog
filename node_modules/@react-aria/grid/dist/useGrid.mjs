...
import {useId as $eV0xE$useId, filterDOMProps as $eV0xE$filterDOMProps, nodeContains as $eV0xE$nodeContains, getEventTarget as $eV0xE$getEventTarget, mergeProps as $eV0xE$mergeProps} from "@react-aria/utils";
...
function $83c6e2eafa584c67$export$f6b86a04e5d66d90(props, state, ref) {
    ...
    let onFocus = (0, $eV0xE$useCallback)((e)=>{
        if (manager.isFocused) {
            ...
            if (!(0, $eV0xE$nodeContains)(e.currentTarget, (0, $eV0xE$getEventTarget)(e))) manager.setFocused(false);
            return;
        }
        // Focus events can bubble through portals. Ignore these events.
        if (!(0, $eV0xE$nodeContains)(e.currentTarget, (0, $eV0xE$getEventTarget)(e))) return;
