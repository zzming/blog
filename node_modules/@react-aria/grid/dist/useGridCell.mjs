...
import {isFocusWithin as $j4Qbl$isFocusWithin, getActiveElement as $j4Qbl$getActiveElement, nodeContains as $j4Qbl$nodeContains, getEventTarget as $j4Qbl$getEventTarget, scrollIntoViewport as $j4Qbl$scrollIntoViewport, getScrollParent as $j4Qbl$getScrollParent, mergeProps as $j4Qbl$mergeProps} from "@react-aria/utils";
...
function $ab90dcbc1b5466d0$export$c7e10bfc0c59f67c(props, state, ref) {
    ...
    let focus = ()=>{
        if (ref.current) {
            ...
            if (focusMode === 'child') {
                ...
                if ((0, $j4Qbl$isFocusWithin)(ref.current) && ref.current !== (0, $j4Qbl$getActiveElement)()) return;
            ...
            if (keyWhenFocused.current != null && node.key !== keyWhenFocused.current || !(0, $j4Qbl$isFocusWithin)(ref.current)) (0, $j4Qbl$focusSafely)(ref.current);
        }
    };
    ...
    let onKeyDownCapture = (e)=>{
        let activeElement = (0, $j4Qbl$getActiveElement)();
        if (!(0, $j4Qbl$nodeContains)(e.currentTarget, (0, $j4Qbl$getEventTarget)(e)) || state.isKeyboardNavigationDisabled || !ref.current || !activeElement) return;
        ...
        switch(e.key){
            ...
            case 'ArrowDown':
                ...
                if (!e.altKey && (0, $j4Qbl$nodeContains)(ref.current, (0, $j4Qbl$getEventTarget)(e))) {
    ...
    let onFocus = (e)=>{
        ...
        if ((0, $j4Qbl$getEventTarget)(e) !== ref.current) {
        ...
        requestAnimationFrame(()=>{
            if (focusMode === 'child' && (0, $j4Qbl$getActiveElement)() === ref.current) focus();
        });
    };
