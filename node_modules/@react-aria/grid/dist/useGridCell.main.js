...
function $cf2021be63b01ef4$export$c7e10bfc0c59f67c(props, state, ref) {
    ...
    let focus = ()=>{
        if (ref.current) {
            ...
            if (focusMode === 'child') {
                ...
                if ((0, $9yLAi$reactariautils.isFocusWithin)(ref.current) && ref.current !== (0, $9yLAi$reactariautils.getActiveElement)()) return;
            ...
            if (keyWhenFocused.current != null && node.key !== keyWhenFocused.current || !(0, $9yLAi$reactariautils.isFocusWithin)(ref.current)) (0, $9yLAi$reactariainteractions.focusSafely)(ref.current);
        }
    };
    ...
    let onKeyDownCapture = (e)=>{
        let activeElement = (0, $9yLAi$reactariautils.getActiveElement)();
        if (!(0, $9yLAi$reactariautils.nodeContains)(e.currentTarget, (0, $9yLAi$reactariautils.getEventTarget)(e)) || state.isKeyboardNavigationDisabled || !ref.current || !activeElement) return;
        ...
        switch(e.key){
            ...
            case 'ArrowDown':
                ...
                if (!e.altKey && (0, $9yLAi$reactariautils.nodeContains)(ref.current, (0, $9yLAi$reactariautils.getEventTarget)(e))) {
    ...
    let onFocus = (e)=>{
        ...
        if ((0, $9yLAi$reactariautils.getEventTarget)(e) !== ref.current) {
        ...
        requestAnimationFrame(()=>{
            if (focusMode === 'child' && (0, $9yLAi$reactariautils.getActiveElement)() === ref.current) focus();
        });
    };
