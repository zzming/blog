...
function $ffbc150311c75f01$export$ae780daf29e6d456(props) {
    ...
    let { hoverProps: hoverProps, triggerHoverEnd: triggerHoverEnd } = (0, $82z6W$react.useMemo)(()=>{
        let triggerHoverStart = (event, pointerType)=>{
            ...
            if (isDisabled || pointerType === 'touch' || state.isHovered || !(0, $82z6W$reactariautils.nodeContains)(event.currentTarget, (0, $82z6W$reactariautils.getEventTarget)(event))) return;
            ...
            addGlobalListener((0, $82z6W$reactariautils.getOwnerDocument)((0, $82z6W$reactariautils.getEventTarget)(event)), 'pointerover', (e)=>{
                if (state.isHovered && state.target && !(0, $82z6W$reactariautils.nodeContains)(state.target, (0, $82z6W$reactariautils.getEventTarget)(e))) triggerHoverEnd(e, e.pointerType);
            }, {
                capture: true
            });
        ...
        if (typeof PointerEvent !== 'undefined') {
            ...
            hoverProps.onPointerLeave = (e)=>{
                if (!isDisabled && (0, $82z6W$reactariautils.nodeContains)(e.currentTarget, (0, $82z6W$reactariautils.getEventTarget)(e))) triggerHoverEnd(e, e.pointerType);
            };
            ...
            hoverProps.onMouseLeave = (e)=>{
                if (!isDisabled && (0, $82z6W$reactariautils.nodeContains)(e.currentTarget, (0, $82z6W$reactariautils.getEventTarget)(e))) triggerHoverEnd(e, 'mouse');
            };
        }
        return {
