import {getEventTarget as $3xCwh$getEventTarget, nodeContains as $3xCwh$nodeContains, useLayoutEffect as $3xCwh$useLayoutEffect} from "@react-aria/utils";
...
class $a86207c5d7f7e1fb$var$LandmarkManager {
   ...
   */ f6Handler(e) {
        if (e.key === 'F6') {
            ...
            let handled = e.altKey ? this.focusMain() : this.navigate((0, $3xCwh$getEventTarget)(e), e.shiftKey);
            if (handled) {
                e.preventDefault();
                e.stopPropagation();
            }
   ...
   */ focusinHandler(e) {
        let currentLandmark = this.closestLandmark((0, $3xCwh$getEventTarget)(e));
        if (currentLandmark && currentLandmark.ref.current !== (0, $3xCwh$getEventTarget)(e)) this.updateLandmark({
            ref: currentLandmark.ref,
            lastFocused: (0, $3xCwh$getEventTarget)(e)
        });
   ...
   */ focusoutHandler(e) {
        let previousFocusedElement = (0, $3xCwh$getEventTarget)(e);
