...
class $202c109aedff6705$var$LandmarkManager {
   ...
   */ f6Handler(e) {
        if (e.key === 'F6') {
            ...
            let handled = e.altKey ? this.focusMain() : this.navigate((0, $iIApB$reactariautils.getEventTarget)(e), e.shiftKey);
            if (handled) {
                e.preventDefault();
                e.stopPropagation();
            }
   ...
   */ focusinHandler(e) {
        let currentLandmark = this.closestLandmark((0, $iIApB$reactariautils.getEventTarget)(e));
        if (currentLandmark && currentLandmark.ref.current !== (0, $iIApB$reactariautils.getEventTarget)(e)) this.updateLandmark({
            ref: currentLandmark.ref,
            lastFocused: (0, $iIApB$reactariautils.getEventTarget)(e)
        });
   ...
   */ focusoutHandler(e) {
        let previousFocusedElement = (0, $iIApB$reactariautils.getEventTarget)(e);
