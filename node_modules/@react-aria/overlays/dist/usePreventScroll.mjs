import {useLayoutEffect as $7mMvr$useLayoutEffect, isIOS as $7mMvr$isIOS, chain as $7mMvr$chain, getEventTarget as $7mMvr$getEventTarget, isScrollable as $7mMvr$isScrollable, getScrollParent as $7mMvr$getScrollParent, willOpenKeyboard as $7mMvr$willOpenKeyboard, getActiveElement as $7mMvr$getActiveElement} from "@react-aria/utils";
...
function $49c51c25361d4cd2$var$preventScrollMobileSafari() {
    ...
    let onTouchStart = (e)=>{
        ...
        let target = (0, $7mMvr$getEventTarget)(e);
...
@layer {
  * {
    ...
    HTMLElement.prototype.focus = function(opts) {
        ...
        let activeElement = (0, $7mMvr$getActiveElement)();
        let wasKeyboardVisible = activeElement != null && (0, $7mMvr$willOpenKeyboard)(activeElement);
