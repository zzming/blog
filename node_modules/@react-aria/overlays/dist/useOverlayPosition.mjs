...
import {isFocusWithin as $39EOa$isFocusWithin, getActiveElement as $39EOa$getActiveElement, useLayoutEffect as $39EOa$useLayoutEffect, useResizeObserver as $39EOa$useResizeObserver} from "@react-aria/utils";
...
function $2a41e45df1593e64$export$d39e1813b3bdd0e1(props) {
    ...
    let updatePosition = (0, $39EOa$useCallback)(()=>{
        ...
        let anchor = null;
        if (scrollRef.current && (0, $39EOa$isFocusWithin)(scrollRef.current)) {
            var _getActiveElement;
            let anchorRect = (_getActiveElement = (0, $39EOa$getActiveElement)()) === null || _getActiveElement === void 0 ? void 0 : _getActiveElement.getBoundingClientRect();
        ...
        let activeElement = (0, $39EOa$getActiveElement)();
