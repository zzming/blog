...
function $dc204e8ec58447a6$export$7941f8aafa4b6021(options) {
    ...
    let onDragStart = (e)=>{
        ...
        if (modalityOnPointerDown.current === 'virtual') {
            e.preventDefault();
            startDragging((0, $3w36N$reactariautils.getEventTarget)(e));
        ...
        let target = (0, $3w36N$reactariautils.getEventTarget)(e);
    ...
    interactions = {
        ...
        onKeyDownCapture (e) {
            if ((0, $3w36N$reactariautils.getEventTarget)(e) === e.currentTarget && e.key === 'Enter') {
                e.preventDefault();
                e.stopPropagation();
            }
        },
