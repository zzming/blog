...
import {useGlobalListeners as $72Evg$useGlobalListeners, getEventTarget as $72Evg$getEventTarget, useDescription as $72Evg$useDescription, isVirtualPointerEvent as $72Evg$isVirtualPointerEvent, isVirtualClick as $72Evg$isVirtualClick} from "@react-aria/utils";
...
function $8253ed7ece74b463$export$7941f8aafa4b6021(options) {
    ...
    let onDragStart = (e)=>{
        ...
        if (modalityOnPointerDown.current === 'virtual') {
            e.preventDefault();
            startDragging((0, $72Evg$getEventTarget)(e));
        ...
        let target = (0, $72Evg$getEventTarget)(e);
    ...
    interactions = {
        ...
        onKeyDownCapture (e) {
            if ((0, $72Evg$getEventTarget)(e) === e.currentTarget && e.key === 'Enter') {
                e.preventDefault();
                e.stopPropagation();
            }
        },
