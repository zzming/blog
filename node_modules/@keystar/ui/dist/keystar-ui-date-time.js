...
const Input = /*#__PURE__*/forwardRef(function Input(props, forwardedRef) {
  ...
  const isInvalid = ((_props$isInvalid = props.isInvalid) !== null && _props$isInvalid !== void 0 ? _props$isInvalid : validationState === "invalid") && !isDisabled;
...
function DateField(props, ref) {
  ...
  let t5;
  if ($[11] !== fieldRef || $[12] !== isReadOnly || $[13] !== fieldProps || $[14] !== isDisabled || $[15] !== autoFocus || $[16] !== t2.isInvalid || $[17] !== t3 || $[18] !== t4) {
...
function DatePicker(props, forwardedRef) {
  ...
  let t5;
  if ($[10] !== isHovered || $[11] !== isFocused || $[12] !== t4 || $[13] !== isDisabled || $[14] !== isReadOnly || $[15] !== state.isInvalid) {
    t5 = {
      isHovered,
      isFocused,
      isFocusVisible: t4,
  ...
  const styleProps = usePickerStyles(t5);
  let t6;
  if ($[17] !== groupProps || $[18] !== hoverProps || $[19] !== focusProps) {
    t6 = mergeProps(groupProps, hoverProps, focusProps);
    $[17] = groupProps;
    $[18] = hoverProps;
    $[19] = focusProps;
    $[20] = t6;
  ...
  let t7;
  if ($[21] !== fieldProps) {
    t7 = /*#__PURE__*/jsx(DatePickerField, {
      ...fieldProps,
  ...
  let t8;
  if ($[23] !== isDisabled || $[24] !== state.isInvalid || $[25] !== styleProps.input || $[26] !== t7) {
  ...
  if ($[28] !== buttonProps || $[29] !== focusPropsButton) {
    t9 = mergeProps(buttonProps, focusPropsButton);
    $[28] = buttonProps;
    $[29] = focusPropsButton;
    $[30] = t9;
  } else {
  ...
  const t10 = isDisabled || isReadOnly;
  let t11;
  ...
  let t12;
  if ($[32] !== t9 || $[33] !== styleProps.button || $[34] !== state.isInvalid || $[35] !== t10) {
    t12 = /*#__PURE__*/jsx(FieldButton, {
      ...t9,
      ...styleProps.button,
      isInvalid: state.isInvalid,
      isDisabled: t10,
  ...
  let t14;
  if ($[41] !== dialogProps || $[42] !== props.shouldFlip || $[43] !== state || $[44] !== triggerRef || $[45] !== t13) {
    t14 = /*#__PURE__*/jsx(DatePickerPopover, {
  ...
  let t15;
  if ($[47] !== t6 || $[48] !== styleProps.root || $[49] !== triggerRef || $[50] !== t8 || $[51] !== t12 || $[52] !== t14) {
  ...
  let t16;
  if ($[54] !== props || $[55] !== domRef || $[56] !== description || $[57] !== labelProps || $[58] !== descriptionProps || $[59] !== errorMessageProps || $[60] !== t15) {
    t16 = /*#__PURE__*/jsx(FieldPrimitive, {
      ...props,
      ref: domRef,
      description: description,
      labelElementType: "span",
...
function DateRangePicker(props, forwardedRef) {
  ...
  let t11;
  if ($[26] !== isDisabled || $[27] !== state.isInvalid || $[28] !== styleProps.input || $[29] !== t8 || $[30] !== t10) {
  ...
  let t15;
  if ($[36] !== t12 || $[37] !== styleProps.button || $[38] !== state.isInvalid || $[39] !== t13) {
...
function TimeField(props, ref) {
  ...
  let t3;
  if ($[3] !== inputRef || $[4] !== fieldProps || $[5] !== isDisabled || $[6] !== autoFocus || $[7] !== t1.isInvalid || $[8] !== t2) {
    t3 = /*#__PURE__*/jsx(Input, {
      ref: inputRef,
      fieldProps: fieldProps,
      isDisabled: isDisabled,
      autoFocus: autoFocus,
      isInvalid: t1.isInvalid,
      children: t2
    });
    $[3] = inputRef;
    $[4] = fieldProps;
